...
The shared vocabulary these decisions are written in is `CONTEXT.md` at the repo root. A word
that means two things is the same failure as a decision nobody recorded.
